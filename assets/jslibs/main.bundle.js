...
var Progressable = exports.Progressable = function Progressable(c) {
    return function (_c) {
        _inherits(_class, _c);
        ...
        function _class() {
            ...
            if (_this.constructor.defaultprogress) {
                _this.addProgressMonitor(_this.constructor.defaultprogress);
            }
            return _this;
        }

        _createClass(_class, [{
            key: "addProgressMonitor",
            value: function addProgressMonitor(progressdisplay) {
                this.progress = progressdisplay;
                if (_get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), "length", this)) {
                    if (this.progress.show) {
                        this.progress.show(_get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), "length", this));
                    } else this.progress.setAttribute("max", _get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), "length", this));
                }
            }
        }, {
            key: "pop",
            value: function pop() {
                if (_get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), "pop", this)) {
                    this.progressrun(1);
                    return _get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), "pop", this).call(this);
                }
            }
        }, {
            key: "push",
            value: function push(v) {
                if (_get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), "push", this)) {
                    this.progressgrow(1);
                    return _get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), "push", this).call(this, v);
                }
            }
        }, {
            key: "splice",
            value: function splice() {
                if (_get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), "splice", this)) {
                    if (arguments.length > 1) this.progressrun(arguments[1]);else {
                        this.progressrun(_get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), "length", this));
                    }
                    if (arguments.length > 2) this.progressgrow(arguments.length - 2);
                    return _get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), "splice", this).apply(this, arguments);
                }
            }
        }, {
            key: "progressgrow",
            value: function progressgrow(v) {
                if (this.progress) {
                    if (this.progress.show) {
            ...
            key: "addDefaultProgressMonitor",
            value: function addDefaultProgressMonitor(defaultprogress) {
...
var Fifo = function (_Array) {
    _inherits(Fifo, _Array);

    function Fifo() {
        _classCallCheck(this, Fifo);

        return _possibleConstructorReturn(this, (Fifo.__proto__ || Object.getPrototypeOf(Fifo)).apply(this, arguments));
    }

    _createClass(Fifo, [{
        key: "pop",
        value: function pop() {
            return _get(Fifo.prototype.__proto__ || Object.getPrototypeOf(Fifo.prototype), "shift", this).call(this);
        }
    }]);
...
function section(desc) {
  var section = (0, _Element.element)("div" + desc);
...
exports.ModTreeWalker = ModTreeWalker;

var _Element = __webpack_require__(0);

var _Element2 = _interopRequireDefault(_Element);

var _Progressable2 = __webpack_require__(1);

var _Progressable3 = _interopRequireDefault(_Progressable2);
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } /* basic/Modules.js */

/* global location, document */

var ModuleStack = exports.ModuleStack = function (_Progressable) {
    _inherits(ModuleStack, _Progressable);

    function ModuleStack() {
        _classCallCheck(this, ModuleStack);

        var _this = _possibleConstructorReturn(this, (ModuleStack.__proto__ || Object.getPrototypeOf(ModuleStack)).call(this));
    ...
    _createClass(ModuleStack, [{
                    ...
                    if (params.module.data.action != "none") {
                        if (params.mod.data.action.search(/\.js$/i) == -1) {
                            ...
                            if (this.loadstate(params.module.name) == null) {
                                ...
                                addModule(params.module.data.action, this.run.bind(this, params.module.name)).catch(console.error);
                            } else return null;
                        }
                    }
                }
        ...
        key: 'addtree',
        value: function addtree(tree, root) {
            /*
            tree = {
    ...
    return ModuleStack;
}((0, _Progressable3.default)(Array));
...
function addModule(url, callback) {
    if (!url || checkRes("script", url)) return null;else return new Promise(function (success) {
...
function ModTreeWalker(modtree, docroot, modstack) {
    var m;
    for (m in modtree) {
...
var _Fifo = __webpack_require__(2);
...
var Network = function (_Progressable) {
    _inherits(Network, _Progressable);
    ...
    _createClass(Network, [{
        key: 'test',
        value: function test(url, handler) {
    ...
    return Network;
}((0, _Progressable3.default)(_Fifo2.default));
...
var Reader = function (_Progressable) {
    _inherits(Reader, _Progressable);
    ...
    _createClass(Reader, [{
        key: 'read',
        value: function read(file, handler) {
...
function selector(desc) {
    var selector = (0, _Section.section)(".selector" + desc);
...
function label(val) {
    var label = (0, _Element.element)("div" + (arguments[1] || ""));
...
var _addWheelListener = __webpack_require__(16);

var _addWheelListener2 = _interopRequireDefault(_addWheelListener);

var _isScrolledIntoView = __webpack_require__(18);
...
var _Progressable = __webpack_require__(1);
...
var _Scrollable = __webpack_require__(15);
...
var _CookieStack = __webpack_require__(8);
...
var _Reader = __webpack_require__(11);

var _Reader2 = _interopRequireDefault(_Reader);

var _TimerStack = __webpack_require__(12);
...
/*basic.js*/
(0, _Modules.addStyle)('/styles/basic.css', function () {
